...
<body>
    ...
    <div class="container">
        ...
        <div class="views-badge">
            <img src="https://komarev.com/ghpvc/?username=OsamaTech10&color=00d9ff&style=flat&label=Profile+Views"
                alt="Profile Views">
        </div>
        ...
        <footer>
            <p class="footer-text">
                <span class="footer-accent">⚡</span> Built with passion · Always learning · Never stopping
            </p>
        </footer>
