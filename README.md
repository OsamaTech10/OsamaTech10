...
<details>
<p><strong><summary>🎧  Hi I'm Osama Ahmed أسامة أحمد:  </summary></strong></p>

[![Spotify](https://spotify-readme.sp-xd.vercel.app/api/spotify)](https://open.spotify.com/user/somnathpaul)

</details>

![Totals Hits](https://komarev.com/ghpvc/?username=OsamaTech10&style=flat&color=orange&label=PROFILE+VIEWS)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Osama_Ahmed-blue?style=flat&logo=linkedin)](https://www.linkedin.com/in/osama-ahmed-113102361)
...
class OsamaAhmed {
  public:
    string currentlyLearning = "C++ using Visual Studio 2022";
    string goal = "To become a professional software developer";
    string status = "Beginner, learning step by step";
};
